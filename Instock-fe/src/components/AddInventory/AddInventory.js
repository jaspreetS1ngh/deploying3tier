    ...
    <>
      <section className="addInventory">
        <div className="addInventory__heading">
          <img
            className="addInventory__heading-arrow"
            src={arrowBack}
            alt="Back arrow"
          />
          <h1 className="addInventory__heading-title">
          ...
          <form className="item-form" onSubmit={submitForm}>
            <div className="item-form__container">
              ...
              <div className="item-form__availability">
                ...
                <div className="item-form__status">
                  ...
                  <div className="item-form__status-container">
                    <input
                      ...
                      onChange={handleChange}
                    />
                    <p className="item-form__status-container-text">
                      Out of stock
                    </p>
                  </div>
                </div>
                ...
                >
                  ...
                  <option type="text" value="Washington">
                    Washington
                  </option>
                  <option type="text" value="Jersey">
                    Jersey
                  </option>
            ...
            <div className="item-form__button">
              <div className="item-form__button-container">
                ...
                <button type="submit" className="item-form__button-add">
                  + Add Item
                </button>
              </div>
            </div>
